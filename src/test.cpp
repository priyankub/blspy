...
TEST_CASE("Achi test vectors") {
    SECTION("Achi test vectors 1 (Basic)") {
    ...
    SECTION("Achi test vector 2 (Augmented, aggregate of aggregates)") {
    ...
    SECTION("Achi test vector 3 (PoP)") {
